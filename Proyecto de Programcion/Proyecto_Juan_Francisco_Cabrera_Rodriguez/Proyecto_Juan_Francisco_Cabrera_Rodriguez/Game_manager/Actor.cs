...
{
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'Iprogramable' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'Iprogramable' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
   public class Actor : IActor, IDibuja, Iprogramable
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'Iprogramable' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'Iprogramable' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
   {
      // IActor
      private int _ataque;
